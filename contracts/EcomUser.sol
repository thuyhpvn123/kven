...
contract EcomUserContract {
    ...
    function setCustomerNotificationSetting(
        ...
        require(
            ...
            '{"from": "EcomProduct.sol","code": 51, "message": "You are not a customer."}'
        );
    ...
    function setRetailerNotificationSetting(
        ...
        require(
            ...
            '{"from": "EcomProduct.sol","code": 51, "message": "You are not a retailer."}'
        );
    ...
    function registerRetailer(
        ...
        require(
            mUserInfo[msg.sender].role != ROLE.RETAILER,
            '{"from": "EcomProduct.sol","code": 1, "message": "The user is already registered as a retailer."}'
        );
        require(
            SCKven.CheckActiveMember(msg.sender),
            '{"from": "EcomProduct.sol","code": 1, "message": "Retailer is not an active PO5 member"}'
        );
    ...
    function register(registerParams memory params) public returns (bool) {
        require(
            ...
            '{"from": "EcomProduct.sol","code": 47,"message": "Invalid username"}'
        );
    ...
    function updateUserInfo(
        ...
        require(
            ...
            '{"from": "EcomProduct.sol","code": 43,"message": "Invalid user"}'
        );
    ...
    function CheckUserExists(address _user) external view {
        require(
            mUserInfo[_user].user != address(0),
            getErrorMessage(1, "Invalid User")
        );
    }
